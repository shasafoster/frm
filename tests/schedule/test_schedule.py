...
df_correct_results = df_correct_results[['test_#','period_start','period_end','payment_date']]
...
def test_generate_date_schedule_forward_months():
    ...
    frequency = Frequency.from_code('m')
    direction = 'forward'
...
def test_generate_date_schedule_forward_years():
    ...
    frequency = Frequency.from_code('a')
    direction = 'forward'
...
def test_generate_date_schedule_same_start_and_end_date():
    start_date = pd.Timestamp('2023-01-01')
    end_date = pd.Timestamp('2023-01-01')
    frequency = Frequency.from_code('d')
    direction = 'forward'
