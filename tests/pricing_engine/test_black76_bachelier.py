...
def test_black76_sln_to_normal_vol():
    F = 4.47385 / 100
    tau = 0.758904109589041
    K = 4 / 100
...
def test_normal_vol_to_black76_ln():
    ...
    vol_n = 87.67 / 10000
    ln_shift = 0
    vol_sln = normal_vol_to_black76_sln(F=F, tau=tau, K=K, vol_n=vol_n, ln_shift=ln_shift)
...
if __name__ == "__main__":
    ...
    test_black76_sln_to_normal_vol() # 1.4s for 1000 iterations
