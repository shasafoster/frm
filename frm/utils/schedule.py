...
from frm.enums.utils import RollConvention, TimingConvention, StubType, PeriodFrequency, DayRoll
...
def get_payment_dates(
    ...
    TODO: Consider options for passing param=(schedule, None, None, None, None) to function
