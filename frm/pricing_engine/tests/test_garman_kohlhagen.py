...
class TestGarmanKohlhagenMethods(unittest.TestCase):
    ...
    def test_unit_price(self):
        ...
        cp=1
        K=0.7882
        px = gk_price(S=S,tau=tau,r_f=r_f,r_d=r_d,cp=cp,K=K,σ=σ)
    ...
    def test_strike(self):
        ...
        strike = gk_solve_strike(S=S,tau=tau,r_f=r_f,r_d=r_d,σ=σ,Δ=Δ,Δ_convention=Δ_convention)
    ...
    def testGreeks(self):
        ...
        K=0.7882
        F=0.667962
        X, greeks_analytical, greeks_numerical  = gk_price(S=S, tau=tau, r_f=r_f, r_d=r_d, cp=cp, K=K, σ=σ, F=F, analytical_greeks_flag=True, numerical_greeks_flag=True)    
        print('X:',X)
