...
print('Heston1993', heston1993_price_fx_vanilla_european(cp, S0, K[i], tau, rd, rf, v0, vv, kappa, theta, rho, 0))
print('CM_GQ:', heston_carr_madan_fx_vanilla_european(S0, tau, r_f, r_d, cp[i], K[i], v0, vv, kappa, theta, rho, integration_method=0))
print('CM_FFT:', heston_carr_madan_fx_vanilla_european(S0, tau, r_f, r_d, cp[i], K[i], v0, vv, kappa, theta, rho, integration_method=1))
print('COS:', heston_cos_vanilla_european(S0, tau, r_d, r_f, cp[i], K[i], v0, vv, kappa, theta, rho))
