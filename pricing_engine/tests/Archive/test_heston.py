...
from frm.pricing_engine.heston import heston1993_price_fx_vanilla_european, heston_fit_vanilla_fx_smile
...
for i, σ_market in enumerate(σ_market_set):
    if i > -5:
        ...
        v0, vv, kappa, theta, lambda_, rho, IV, SSE = heston_fit_vanilla_fx_smile(Δ, Δ_convention, σ_market, S, r_f[i], r_d[i], tau[i], cp, pricing_method='carr_madan_gauss_kronrod_quadrature')
